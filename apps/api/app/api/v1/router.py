...
from app.api.v1.endpoints import admin, auth, catalog, finance, health, invoices, uploads
...
api_v1_router.include_router(invoices.router, tags=["admin"])
api_v1_router.include_router(finance.router, tags=["admin"])
